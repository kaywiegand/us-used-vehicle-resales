...
| ~~24~~ | ✅ **Entscheidung getroffen (2026-07-17):** "448 Runs" bleibt als historischer Snapshot stehen (Stand des ursprünglichen systematischen Sweeps). Verifiziert: echte `model_results_tracking.csv` hat aktuell 562 Zeilen — nicht weiter gewachsen seit letztem Check, aber bewusst nicht rückwirkend in README/Story nachgezogen (Aufwand: ~15 Stellen + Pipeline-Regenerierung + Preview-Verifikation, kein Fehler in der Sache, nur ein späterer Snapshot). Falls je aktualisiert: "448" konsequent durch den dann aktuellen Wert ersetzen, nicht mischen. | 3 | Kay 2026-07-17 |
