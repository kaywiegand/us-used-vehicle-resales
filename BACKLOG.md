...
| 24 | **"448 Runs"-Zahl veraltet** — echte `model_results_tracking.csv` hat inzwischen 562 Zeilen (kumulativ über mehrere Sessions gewachsen), Story/README zeigen weiterhin 448. Bewusst nicht angefasst am 2026-07-17 (Kay hat "448" in eigenen Formulierungen weiterverwendet) — Entscheidung nachholen: Zahl aktualisieren oder als historischen Snapshot dokumentieren. | 3 | content-audit 2026-07-17 |
